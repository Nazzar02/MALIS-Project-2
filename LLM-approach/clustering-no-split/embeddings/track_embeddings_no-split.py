...
def main():
    playlists_file = "/data/playlist_continuation_data/csvs/playlists.csv"
    items_files="data/playlist_continuation_data/csvs/items.csv"
    tracks_file = "/data/playlist_continuation_data/csvs/tracks.csv"
    output_file = "/home/vellard/malis/embeddings/embeddings.pkl"
    os.makedirs(output_dir, exist_ok=True)#make sur all directories exist (or create them)

    model = SentenceTransformer('sentence-transformers/paraphrase-MiniLM-L6-v2')#pre-trained model
